...
<!-- Überschrift -->
  <v-container  fluid> 
      <div align="left" class="mt-12">
        <p class="display-1 verzeichnis--text"><v-icon color="verzeichnis">mdi-excavator mdi-36px</v-icon>
        Geräte</p>     
      </div>
 </v-container>
    ...
    <!-- TABELLE -->
      ...
      <!-- Tabellen Toolbar    -->
          <v-toolbar flat color="white">
            <v-toolbar-title class="grey--text header">Geräteliste</v-toolbar-title>
                <v-spacer></v-spacer>
                <!-- Filter -->
                    <v-text-field
                        v-model="search"
...
export default {
  ...
  data: () => ({
    ...
    rolles: ['Typen','PDL','ASSITANT','NURSE'],
    dialog: false,
